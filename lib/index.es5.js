...
if (!Array.prototype.hasOwnProperty('diff')) {
    Object.defineProperty(Array.prototype, 'diff', {
        enumerable: false,
        value: function (a2) {
            return this.concat(a2).filter(function (val, index, arr) {
...
parser.parseName = function (name) {
    ...
    const firstNameFirstFormat = parts.every(function part() {
    ...
    if (!firstNameFirstFormat) {
        ...
        const lastName = parts.reduce(function (lastName, current, index) {
